 ...
 * @brief Common string type for Geant4
 *
 ...
 *
 * @sa `std::string` for primary interfaces
 * @sa G4StrUtil for additional query/manipulation functions
 *
 */
class G4String : public std::string
{
 public:
   ...
   * 
   * See per-function documentation for replacements.
   */
  ...
  //! @deprecated Use G4StrUtil::lstrip, G4StrUtil::rstrip, G4StrUtil::strip functions instead.
  ...
  //! @deprecated Use G4StrUtil::to_lower functions instead.
  [[deprecated("Use G4StrUtil::to_lower/to_lower_copy instead")]]
  inline void toLower();

  //! @deprecated Use G4StrUtil::to_upper functions instead.
...
namespace G4StrUtil
{
   ...
   * @return uppercased copy of @p str
   */
   ...
   * @post @p str has any leading sequence of @p ch removed
   */
   ...
   * @param[in,out] str string to strip
   * @param[in] ch character to remove
   * @post @p str has any trailing sequence of @p ch removed
   */
   ...
   * @param[in,out] str string to strip
   * @param[in] ch character to remove
   * @post @p str has any leading and trailing sequence of @p ch removed.
   */
   ...
   * @param[in] ch character to remove
   * @return copy of @p str with any leading sequence of @p ch removed.
   */
   ...
   * @param[in] str string to copy and strip
   * @param[in] ch character to remove
   * @return copy of @p str with any trailing sequence of @p ch removed
   */
   ...
   * @param[in] str string to copy and strip
   * @param[in] ch character to remove
   * @return copy of @p str with any leading and trailing sequence of @p ch removed
   */
   ...
   * @return negative(positive) `G4int` if lowercased @p lhs appears
   *   before(after) lowercased @p rhs in lexicographical order, zero if both
   ...
   * @post @p str is unchanged if `index > str.size()`, otherwise `str` has
   ...
   * @param[in] skipWhite if true, discard leading whitespace from @p is
   * @return @p is
   */
